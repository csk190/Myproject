...
* **Learners Profile:** The target learners are 1st-grade students at **Seosang High School** (mixed-ability, approximately 10 students per class). Students exhibit varying levels of intrinsic motivation, with a distinct polarization between upper-tier fluent readers and lower-tier students struggling with foundational syntax and core vocabulary.
...
## 🚀 3. App Purpose ([Class_apps 웹 앱 바로가기](https://miniproject-djyhkowbsqtoov8yham3m9.streamlit.app/))
